    ...
    {   
        ...
        switch ($attribute) {
            case 'POST_EDIT':   
                ...
                else if($userConnect->getRoles()[0]==="ROLE_PARTENAIRE" && $subject->getRoles()[0] === "ROLE_ADMIN_PARTENAIRE" || $subject->getRoles()[0] === "ROLE_USER_PARTENAIRE") {
                    return true; 
            ...
            case 'POST_VIEW':
                ...
                if($userConnect->getRoles()[0]==="ROLE_USER_PARTENAIRE"){
                    return false;  
                }
                break;   
            default:
